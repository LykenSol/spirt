...
pub fn emulate_call_stack(module: &mut Module, config: &crate::callgraph::CallStackEmuConfig) {
    crate::callgraph::CallStackEmulator::new(module, config).transform_module(module);
}
